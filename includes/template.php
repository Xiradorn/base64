  ...
  <body>
    ...
    <div class="container starter-form">
      <div class="row">
        <div class="col-md-12">
          <h2>Base64 Encode</h2>
		  <img src="{$base64_struct['html']}" class="img-responsive thumbnail" style="margin: 0 auto; max-width: 350px;"><br>
			MIME: { {$file_mime} }<br>
			...
			<br><br>
			Base64: 
			<div style="height: 100px; overflow: auto;">{$base64_struct['html']}</div>
        </div>
      </div>
    </div>
